...
ZRP.SetTimeout = function(msec, cb)
  table.insert(ZRP.TimeoutCallbacks, {
    cb = cb,
...
ZRP.Game.GetClosestObject = function(coords, modelFilter)
  return ZRP.Game.GetClosestEntity(ZRP.Game.GetObjects(), false, coords, modelFilter)
end
ZRP.Game.GetClosestPed = function(coords, modelFilter)
  return ZRP.Game.GetClosestEntity(ZRP.Game.GetPeds(true), false, coords, modelFilter)
end
ZRP.Game.GetClosestPlayer = function(coords)
  return ZRP.Game.GetClosestEntity(ZRP.Game.GetPlayers(true, true), true, coords, nil)
end
ZRP.Game.GetClosestVehicle = function(coords, modelFilter)
  return ZRP.Game.GetClosestEntity(ZRP.Game.GetVehicles(), false, coords, modelFilter)
end
ZRP.Game.GetPlayersInArea = function(coords, maxDistance)
  return EnumerateEntitiesWithinDistance(ZRP.Game.GetPlayers(true, true), true, coords, maxDistance)
end
ZRP.Game.GetVehiclesInArea = function(coords, maxDistance)
  return EnumerateEntitiesWithinDistance(ZRP.Game.GetVehicles(), false, coords, maxDistance)
end
ZRP.Game.IsSpawnPointClear = function(coords, maxDistance)
  return #ZRP.Game.GetVehiclesInArea(coords, maxDistance) == 0
end
